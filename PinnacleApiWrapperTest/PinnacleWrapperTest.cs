...
namespace PinnacleApiWrapperTest
{
    ...
    public class PinnacleWrapperTest
    {
        ...
        public async Task GetAsyncSportsResponse_WithSportsList_ReturnSportsList()
        {
            ...
            // Act
            var result = await client.GetAsyncSportsResponse();
        ...
        public async Task GetAsyncLeagues_WithSports4_ReturnBasketLeagues()
        {
            ...
            // Act
            var result = await client.GetAsyncLeagues("4");

            // Assert
            Assert.IsNotNull(result);
            Assert.AreEqual(250, result.Leagues1.Count);
            var abaLeagueAllStar = result.Leagues1.Single(x => x.Id == 267);
            ...
            var leagueFrance = result.Leagues1.Single(x => x.Id == 412);
            ...
            var nba = result.Leagues1.Single(x => x.Id == 487);
        ...
        public async Task GetAsyncFixturesResponse_WithSports4AndLeague_ReturnAvailableLines()
        {
            ...
            // Act
            var result = await client.GetAsync(4, new List<int> {487}, null, null, null);
            ...
            Assert.AreEqual(new DateTime(2018, 02, 27, 00, 35, 00, DateTimeKind.Utc), gameFixture.Starts);
            ...
            Assert.AreEqual(FixtureLiveStatus._2, gameFixture.LiveStatus);
            Assert.AreEqual(FixtureStatus.I, gameFixture.Status);
            Assert.AreEqual(FixtureParlayRestriction._0, gameFixture.ParlayRestriction);
        }
        ...
        public async Task GetAsyncOddsResponse_WithSports4AndLeague487Event820378812_ReturnAvailableOddsInDecimal()
        {
            ...
            // Act
            var result = await client.GetAsync(4, new List<int> {487}, OddsFormat.DECIMAL, 1519846285090, null,
                new List<long> {820378812});
            ...
            Assert.AreEqual(new DateTime(2018, 03, 01, 03, 35, 00, DateTimeKind.Utc), line.Cutoff);
        ...
        public async Task StraightV2Async_WithPlaceBetRequest_ReturnPlaceBetResponseV2()
        {
            ...
            // Act
            var result = await client.StraightV2Async(placeBetRequest);
            ...
            Assert.AreEqual(new DateTime(2017, 09, 05, 01, 32, 59, DateTimeKind.Utc), result.StraightBet.PlacedAt);
